...
<head>
    ...
    <title><?php echo ADMIN_PACKAGE_TITLE; ?></title>
                                ...
                                <table id="tbl" class="table text-nowrap">
                                    ...
                                    <?php while($row = $package_data->fetch_assoc()){
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="packages-edit.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp; | &nbsp;<a href="datadelete.php?id=<?php echo $row['id'];?>&function_name=packagesdelete">Delete</a>
                                            </td>
