...
<head>
    ...
    <title><?php echo ADMIN_STATELIST_ADD_TITLE; ?></title>
                                ...
                                <form class="form-horizontal form-material" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="name" placeholder="Enter State"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select onchange="loadstate(this.value)" name="country_id" class="form-select shadow-none p-0 border-0 form-control-line" required>
