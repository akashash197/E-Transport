...
<head>
    ...
    <title><?php echo ADMIN_VEHICLE_MAKE_TITLE; ?></title>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="tbl" class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <?php while($row = $make_data->fetch_assoc()){ ?>  
                                        <tr>
                                            <td><?php echo $row['id'];?></td>
                                            <td><?php echo $row['name'];?></td>
                                            <td><a href="vehicle-make-edit.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp; | &nbsp;<a href="datadelete.php?id=<?php echo $row['id'];?>&function_name=makedelete">Delete</a>
                                            </td>
