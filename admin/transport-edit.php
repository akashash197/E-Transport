...
$transport_edit_query="select * from tbl_transport where id='".$transportt_id."'";
$transport_edit_data=$conn->query($transport_edit_query);
if ($transport_edit_data->num_rows ==0) 
    {
         header("location:transport-list.php");
    }

$transport_edit_arr = $transport_edit_data->fetch_assoc();

if(isset($_POST) && !empty($_POST))
{   
    $transport_id_in=$_POST['transport_id'];
	...
	$userquery="update tbl_transport set business_name='".$business_name."',gst='".$gst."',pan='".$pan."',owner_name='".$owner."',owner_email='".$owner_email."',owner_mobile='".$owner_mobile."',start_time ='".$business_start."', end_time ='".$business_end."', working_days='".$work_days."', email='".$email."', website='".$website."', transport_mobile='".$transport_mob."', address='".$address."', land_mark='".$landmark."', country_id='".$country_id."', state_id='".$state_id."', city_id='".$city_id."', location_id='".$location_id."', short_description='".$short_desc."', long_description='".$long_desc."', featured='".$featured."',updated_on='".$today_date."' where id='".$transport_id_in."'";
    ...
    if(isset($_FILES) && !empty($_FILES)){
        ...
        $new_file="usr_".date("ymdhis").$transport_id_in.basename($_FILES['logo_image']['name']);
        $destination=$upload_pass.$new_file;
        if(move_uploaded_file($_FILES['logo_image']['tmp_name'],$destination)){
            $logoupdate="update tbl_transport set logo='".$new_file."' where id='".$transport_id_in."'";
            $conn->query($logoupdate);
        }
    }
    if(isset($_FILES) && !empty($_FILES)){
        $upload_pass="../uploads/transport/";
        $new_file="usr_".date("ymdhis").$transport_id_in.basename($_FILES['cover_image']['name']);
        $destination=$upload_pass.$new_file;
        if(move_uploaded_file($_FILES['cover_image']['tmp_name'],$destination)){
            $coverupdate="update tbl_transport set cover='".$new_file."' where id='".$transport_id_in."'";
...
<head>
    ...
    <title><?php echo ADMIN_TRANSPORT_UPDATE_TITLE; ?></title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Update Transport</h4>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="transport_id" value="<?php echo $transport_edit_arr['id']?>"/>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Business Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "business-name" placeholder="Enter Business"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['business_name']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "gst" placeholder="Enter GST"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['gst']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "pan" placeholder="Enter PAN"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['pan']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "owner_name" placeholder="Enter Owner's Name"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['owner_name']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "owner_email" placeholder="Enter Owner's Email"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['owner_email']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "owner_mobile" placeholder="Enter Owner's Mobile"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['owner_mobile']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select  name="start_time" class="form-select shadow-none p-0 border-0 form-control-line" required>
                                                <option value="<?php echo $transport_edit_arr['start_time']?>"  selected><?php echo $transport_edit_arr['start_time']?></option>
                                            ...
                                            <select name="end_time" class="form-select shadow-none p-0 border-0 form-control-line" required>
                                                <option value="<?php echo $transport_edit_arr['end_time']?>" selected><?php echo $transport_edit_arr['end_time']?></option>
                                                <option value="00:00">00:00</option>
                                                <option value="00:30">00:30</option>
                                                <option value="01:00">01:00</option>
                                                <option value="01:30">01:30</option>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select onchange="loadcon(this.value)" name="work_days" class="form-select shadow-none p-0 border-0 form-control-line" required>
                                                <option value="<?php echo $transport_edit_arr['working_days']?>" selected><?php echo $transport_edit_arr['working_days']?></option>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "email" placeholder="Enter Email"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['email']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "website" placeholder="Enter Website"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['website']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "transport_mobile" placeholder="Enter Transport's Mobile"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['transport_mobile']?>" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "address" placeholder="Enter Address"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['address']?>" required>
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "landmark" placeholder="Enter Landmark"
                                                class="form-control p-0 border-0" value="<?php echo $transport_edit_arr['land_mark']?>" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea type="textarea" name= "short_desc" placeholder="Enter Short Description"
                                                class="form-control p-0 border-0" required><?php echo $transport_edit_arr['short_description']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea type="textarea" name= "long_desc" placeholder="Enter Long Description"
                                                class="form-control p-0 border-0" required><?php echo $transport_edit_arr['long_description']?></textarea>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group mb-4">
                                        <label class="col-sm-12">Featured</label>

                                        <div class="col-sm-12 border-bottom">
                                            <select onchange="loadcon(this.value)" name="featured" class="form-select shadow-none p-0 border-0 form-control-line" required>
                                                <option value="<?php echo $transport_edit_arr['featured']?>" selected><?php if($transport_edit_arr['featured']==1){
                                                    echo "Yes";
                                                    } 
                                                    else{
                                                    echo "No";
