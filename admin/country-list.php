...
<head>
    ...
    <title><?php echo ADMIN_COUNTRYLIST_TITLE; ?></title>
                                ...
                                <table id="tbl" class="table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="country-edit.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp; | &nbsp;<a href="datadelete.php?id=<?php echo $row['id'];?>&function_name=countrydelete">Delete</a>
                                            </td>
