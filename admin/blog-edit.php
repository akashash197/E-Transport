...
$blogg_id=$_GET['id'];
$blog_edit_query="select * from tbl_blog where id='".$blogg_id."'";
$blog_edit_data=$conn->query($blog_edit_query);
if ($blog_edit_data->num_rows ==0) 
    {
         header("location:blog-list.php");
    }

$blog_edit_arr = $blog_edit_data->fetch_assoc();
...
if(isset($_POST) && !empty($_POST))
{
    ...
    $blog_id_in=$_POST['blog_id'];
	$userquery="update tbl_blog set title='".$title."',category_id='".$categ_id."',author_id='".$author_id."',short_description='".$short_desc."',long_description='".$long_desc."',updated_on='".$today_date."' where id='".$blog_id_in."'";
    ...
    if(isset($_FILES) && !empty($_FILES)){
        ...
        if(move_uploaded_file($_FILES['blog_image']['tmp_name'],$destination)){
            $blogimageupdate="update tbl_blog set image='".$new_file."' where id='".$blog_id_in."'";
...
<head>
    ...
    <title><?php echo ADMIN_BLOG_UPDATE_TITLE; ?></title>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="blog_id" value="<?php echo $blog_edit_arr['id']?>"/>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Title</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="title" placeholder="Enter title"
                                                class="form-control p-0 border-0" value="<?php echo $blog_edit_arr['title']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea type="textarea" name= "short_desc" placeholder="Enter Short Description"
                                                class="form-control p-0 border-0"><?php echo $blog_edit_arr['short_description']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea type="textarea" name= "long_desc" placeholder="Enter Long Description"
                                                class="form-control p-0 border-0"><?php echo $blog_edit_arr['long_description']?></textarea>
                                        </div>
                                    </div>
