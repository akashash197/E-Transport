...
$inquiry_query="select * from tbl_inquiry order by id desc";
$inquiry_data=$conn->query($inquiry_query);
?>
...
<head>
    ...
    <title><?php echo ADMIN_INQUIRY_TITLE; ?></title>
                                ...
                                <table id="tbl" class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Submitted On</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php while($row = $inquiry_data->fetch_assoc()){
                                            ?>
                                        <tr>
