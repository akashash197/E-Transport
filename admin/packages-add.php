...
if(isset($_POST) && !empty($_POST))
{
    ...
    $userquery="insert into tbl_package(package_name,price,description,created_on,updated_on) values('".$name."','".$price."','".$description."','".$today_date."','".$today_date."')";
...
<head>
    ...
    <title><?php echo ADMIN_PACKAGE_ADD_TITLE; ?></title>
