...
if(isset($_POST) && !empty($_POST))
{
    ...
    if ($data_check->num_rows > 0){
        ...
        $userquery="insert into tbl_blog_category(name,created_on,updated_on) values('".$name."','".$today_date."','".$today_date."')";
...
<head>
    ...
    <title><?php echo ADMIN_BLOG_CATG_ADD_TITLE; ?></title>
                                ...
                                <form class="form-horizontal form-material" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name= "name" placeholder="Enter Blog Category"
