...
$cityy_id=$_GET['id'];
$city_edit_query="select * from tbl_city where id='".$cityy_id."'";
$city_edit_data=$conn->query($city_edit_query);
if ($city_edit_data->num_rows ==0) 
    {
         header("location:city-list.php");
    }

$city_edit_arr = $city_edit_data->fetch_assoc();

if(isset($_POST) && !empty($_POST))
{
    $name=$_POST['city-name'];
    $city_id_in=$_POST['city_id'];
    $country_id=$_POST['country_id'];
    $state_id=$_POST['state_id'];
    $today_date=date("y-m-d");
    $userquery="update tbl_city set name='".$name."',country_id='".$country_id."',state_id='".$state_id."',updated_on='".$today_date."' where id='".$city_id_in."'";
...
<head>
    ...
    <title><?php echo ADMIN_CITYLIST_UPDATE_TITLE; ?></title>
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                ...
                                <li><a href="city-list.php" class="fw-normal">City List</a></li>
                            </ol>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="city_id" value="<?php echo $city_edit_arr['id']?>"/>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">City Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="city-name" placeholder="Enter City"
                                                class="form-control p-0 border-0" value="<?php echo $city_edit_arr['name']?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                        <select id="tblbdy" name="state_id" class="form-select shadow-none p-0 border-0 form-control-line" required>
