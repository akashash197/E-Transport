...
<head>
    ...
    <title><?php echo ADMIN_VEHICLE_MODEL_TITLE; ?></title>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="tbl" class="table text-nowrap">
                                    ...
                                    <tbody>
                                    <?php while($row = $model_data->fetch_assoc()){ ?>  
                                        <tr>
                                            <td><?php echo $row['id'];?></td>
                                            <td><?php echo $row['name'];?></td>
                                            <td><a href="vehicle-model-edit.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp; | &nbsp;<a href="datadelete.php?id=<?php echo $row['id'];?>&function_name=modeldelete">Delete</a>
                                            </td>
