...
<head>
    ...
    <title><?php echo ADMIN_TRANSPORT_TITLE; ?></title>
                                ...
                                <table id="tbl" class="table text-nowrap">
                                    ...
                                    <?php while($row = $transport_data->fetch_assoc()){ ?>
                                        ...
                                        <td><?php echo $row['id'];?></td>
                                            ...
                                            <td><a href="transport-edit.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp; | &nbsp;<a href="datadelete.php?id=<?php echo $row['id'] ?>&function_name=transportdelete">Delete</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
